      ...
      <div className="relative z-10 max-w-4xl mx-auto w-full">
        ...
        <main className="space-y-8 bg-white/5 border border-white/10 backdrop-blur-xl p-8 rounded-2xl shadow-xl leading-relaxed text-sm text-slate-300">
          ...
          <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl flex items-start gap-3 text-red-200 text-xs">
            ...
            <div>
              <strong>Strict Usage Rules:</strong> Finova is designed exclusively for lawful personal financial accounting and document retrieval. Any illegal activities, security exploitation, automated abuse, or unauthorized secret storage will result in immediate account suspension.
            </div>
          </div>
          ...
          <section className="space-y-3">
            ...
            <p>
              Finova must not be used for money laundering, terror financing, tax evasion, fraudulent expense reporting, or any unlawful financial schemes.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              We reserve the right to suspend or terminate accounts that violate this Acceptable Use Policy. If you discover a vulnerability or policy violation, please report it immediately to security@finova.app.
            </p>
          </section>
        ...
        <footer className="mt-8 text-center text-xs text-slate-500">
          Last revised: September 2026. Version 1.0. Finova Compliance Team.
        </footer>
      </div>
    </div>
  );
